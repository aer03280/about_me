...
var timesUp = ('It took you too many guesses.  I\'ve lived in these states: ' + correctStateList + '.');

function stateLive(timesUp) {
...
stateLive('Wow, ' + userName + ', you used up all your guesses.  The states I\'ve lived in are: ' + correctStateList + '. Click ok to see your score.' , 6);
// ///////////////////////////////////////
function giveScore(){
  if (score >= 8) {
